...
class Findposition:
    def __init__(self):
        ...
        rospy.Subscriber("voice/goal_point", Int32MultiArray, voice_object_callback)
        rospy.Subscriber("object_detect", Int64, self.robot_init_callback)	#	等待机械臂完成物体识别的初始状态
...
def robot_init_callback(self,data):
    	self.tag = data.data
        if self.tag == 2:
