...
int main(int argc, char* argv[])
{
	...
	pub = n.advertise<std_msgs::Int32>("/voice/flag_castle_tl_tts_topic", 1); //tts合成播放完成标志位，通知asr可以录音
	ros::NodeHandle nh("~");    //用于launch文件传递参数
	nh.param("appid", appid, string("appid = 5b6d44ed, work_dir = ."));    //从launch文件获取参数
