...
void Listener::callback(const std_msgs::Int64::ConstPtr& msg)
{
  x = msg->data;
  print_datax();
...
// 清除指令队列
    ...
    while (ros::ok()) {
        ...
        do {
            ...
            Listener listener;
            ros::Subscriber sub = n.subscribe("voice/object_color", 1000, &Listener::callback, &listener);
